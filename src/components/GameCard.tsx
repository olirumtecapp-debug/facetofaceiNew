  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-0">
      <button
        type="button"
        onClick={onClick}
        className={`relative flex aspect-[3/4] h-full max-h-[18vh] w-full items-center justify-center overflow-hidden rounded-md border-[1.5px] border-[#d4af37] bg-[#c0c0c0] p-0 transition-all duration-200 ${
