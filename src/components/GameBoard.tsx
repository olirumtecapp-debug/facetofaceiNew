                  ...
                  {gameState.pendingQuestion.revealedAnswer ? (
                    ...
                    <>
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="w-24 aspect-[178/224]">
                          <div className="flex h-full w-full items-center justify-center rounded-lg border-2 border-dashed border-white/20 bg-black/40 text-4xl">
                            ❓
                          </div>
                        </div>
                      </div>
