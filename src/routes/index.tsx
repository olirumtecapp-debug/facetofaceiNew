            ...
            <div className="flex-1 overflow-auto custom-scrollbar p-1">
              <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 md:grid-cols-6 sm:gap-4 lg:gap-6">
                {CHARACTERS.map((c) => (
                  ...
                  >
                    <div className="relative flex aspect-[178/224] w-full items-center justify-center overflow-hidden transition-all group-hover:scale-110 group-active:scale-95">
                      <img
            ...
            {(() => {
              ...
              return (
                <div className="flex flex-col items-center p-4 text-gray-900">
                  <div className="flex w-24 sm:w-32 aspect-[178/224] mb-4 items-center justify-center overflow-hidden">
