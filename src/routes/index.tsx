        ...
        <div className="flex w-full flex-col items-center justify-center gap-10 sm:flex-row sm:gap-16">
          ...
          <div className="group relative">
            ...
            <button
              ...
              className="relative flex h-24 w-fit items-center justify-center overflow-hidden rounded-xl border-4 border-[#1e62ec] bg-[#f5f5f5] p-0.5 transition-all hover:scale-105 active:scale-95 sm:h-28 md:h-32"
            >
              <img 
                src={playIaAsset.url} 
                alt="Jogar vs IA" 
          ...
          <div className="group relative">
            ...
            <button
              ...
              className="relative flex h-24 w-fit items-center justify-center overflow-hidden rounded-xl border-4 border-[#e52e2e] bg-[#f5f5f5] p-0.5 transition-all hover:scale-105 active:scale-95 sm:h-28 md:h-32"
            >
              <img 
