...
export const CHARACTERS: Character[] = [
  ...
  { id: 17, nome: "YURI", genero: "Masculino", corCabelo: "Preto", estiloCabelo: "Curto liso", tomPele: "Claro", corOlhos: "Escuros", barbaBigode: "Nenhum", oculos: false, chapeuBoneFaixa: "Nenhum", brincos: false, acessoriosExtra: "Pacato, gosta de arte e pratica artes marciais", corRoupa: "Azul" },
  ...
  { id: 24, nome: "TIAGO", genero: "Masculino", corCabelo: "Preto", estiloCabelo: "Afro curto", tomPele: "Escuro (Negro)", corOlhos: "Castanhos", barbaBigode: "Nenhum", oculos: false, chapeuBoneFaixa: "Faixa Vermelha", brincos: false, acessoriosExtra: "Curativo no Nariz", corRoupa: "Amarelo" },
];
